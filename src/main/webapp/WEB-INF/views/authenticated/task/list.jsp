...
<acme:list>
	...
	<acme:list-column code="authenticated.task.list.label.begin" path="begin" width="25%"/>
	<acme:list-column code="authenticated.task.list.label.end" path="end" width="25%"/>
